package coreModulePackage.Controller;

import coreModulePackage.Entities.Client;
import coreModulePackage.Repository.ClientRepo;
import coreModulePackage.Validators.ClientValidator;
...
public class ClientService {
    ...
    public List<Client> filterClientsWithNameLessThan(Integer length) throws Exception {
