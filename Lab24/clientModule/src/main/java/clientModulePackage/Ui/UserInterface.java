...
public class UserInterface {
    ...
    public void runConsole() throws Exception {
        ...
        while (true) {
            ...
            System.out.println(" 1 - add | 2 - show | 3 - Update | 4 - delete ");
            System.out.println("Movie: ");
            System.out.println(" 5 - add | 6 - show | 7 - Update | 8 - delete");
            System.out.println("Rent: ");
            System.out.println(" 9 - add | 10 - show | 11 - Update | 12 - delete");
    ...
    private void filterClientByNameLength() throws Exception {
        ...
        try {
            ...
            String URL2 = "http://localhost:8080/api/clients/filter/{length}";
            ClientsDto allClients = rest.getForObject(URL2,ClientsDto.class,length);
            List<ClientDto> list = allClients.getClientDtos();
            list.forEach(System.out::println);
        }catch (Exception e){
            e.printStackTrace();
